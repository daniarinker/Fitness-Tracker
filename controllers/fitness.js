...
//   let dbRoutine = await db.Fitness.find({ _id: req.params.fitnessID }).populate(
//     "fitness"
//   );
//   res.status(200).send(dbRoutine);
// });
...
//     try {
//       let dbRoutine = await db.Fitness.findOneAndUpdate(
//         { _id: req.body.fitness },
//         { $push: { workouts: addWorkouts._id } },
//         { new: true }
//       );
//       res.status(200).send(dbRoutine);
//     } catch (err) {
